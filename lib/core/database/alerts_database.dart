...
extension AlertsDatabaseValueExtension on AlertsDatabaseValue {
    ...
    dynamic get data {
        ...
        switch(this) {  
            case AlertsDatabaseValue.CHANGELOG: return box.get(key, defaultValue: '');
        }
    ...
    void put(dynamic value) {
        final box = Database.alertsBox;
        switch(this) {
            case AlertsDatabaseValue.CHANGELOG: if(value.runtimeType == String) box.put(key, value); return;
        }
