...
extension StringExtension on String {
    ...
    String lunaConvertToSlug() => toLowerCase().replaceAll(RegExp(r'[\ \.]'), '-').replaceAll(RegExp(r'[^a-zA-Z0-9\-]'), '').trim();
    ...
    String lunaPad([int count = 1, String padding = ' ']) {
        String _value = padLeft((length+count), padding).padRight((length+(count*2)), padding);
        return _value;
    }
}
