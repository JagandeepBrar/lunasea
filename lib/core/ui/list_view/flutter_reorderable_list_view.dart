...
///
///{@end-tool}
class FlutterReorderableListView extends StatefulWidget {
...
class _ReorderableListViewState extends State<FlutterReorderableListView> {
      ...
      case Axis.vertical:
        if (widget.reverse) {
          ...
          listPadding = EdgeInsets.fromLTRB(
              0, padding.top, 0, widget.header != null ? 0 : padding.bottom);
        } else {
          outerPadding = EdgeInsets.fromLTRB(padding.left, 0, padding.right, 0);
          listPadding = EdgeInsets.fromLTRB(
              0, widget.header != null ? 0 : padding.top, 0, padding.bottom);
        }
        break;
    }
      ...
      child: CustomScrollView(
        ...
        slivers: <Widget>[
          if (widget.header != null)
            SliverPadding(
              padding: EdgeInsets.fromLTRB(0, widget.reverse ? 0 : padding.top,
                  0, widget.reverse ? padding.bottom : 0),
