...
class LunaThreeLineCardWithPoster extends StatelessWidget {
  static final double itemExtent = LunaListTile.extentFromSubtitleLines(2);
  static final double _itemHeight = LunaListTile.heightFromSubtitleLines(2);
  ...
  const LunaThreeLineCardWithPoster({
    Key key,
  ...
  Widget _poster(BuildContext context) {
    return LunaNetworkImage(
      ...
      height: _itemHeight,
      width: posterIsSquare ? _itemHeight : _itemHeight / 1.5,
      headers: posterHeaders,
    );
  }
