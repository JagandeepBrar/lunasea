...
class _State extends State<NZBGetQueueTile> {
    ...
    Future<void> _handlePopup() async {
        ...
        List values = await NZBGetDialogs.showQueueSettingsPrompt(widget.queueContext, widget.data.name, widget.data.paused);
...
class _Helper {
    ...
    Future<void> _category() async {
        ...
        List values = await NZBGetDialogs.showCategoryPrompt(context, categories);
    ...
    Future<void> _priority() async {
        List values = await NZBGetDialogs.showChangePriorityPrompt(context);
    ...
    Future<void> _rename() async {
        List values = await NZBGetDialogs.showRenameJobPrompt(context, data.name);
    ...
    Future<void> _delete() async {
        List values = await NZBGetDialogs.showDeleteJobPrompt(context);
    ...
    Future<void> _password() async {
        List values = await NZBGetDialogs.showSetPasswordPrompt(context);
