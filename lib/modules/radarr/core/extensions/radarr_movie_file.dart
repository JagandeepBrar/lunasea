...
extension LunaRadarrMovieFileExtension on RadarrMovieFile {
  String get lunaRelativePath {
    if (this?.relativePath != null && this.relativePath.isNotEmpty)
  ...
  String get lunaSize {
    if (this?.size != null && this.size != 0)
      return this.size.lunaBytesToString(decimals: 1);
    return LunaUI.TEXT_EMDASH;
  }
  ...
  String get lunaCustomFormats {
    if (this?.customFormats != null && this.customFormats.isNotEmpty)
      return this.customFormats.map<String>((format) => format.name).join('\n');
    return LunaUI.TEXT_EMDASH;
  }
}
