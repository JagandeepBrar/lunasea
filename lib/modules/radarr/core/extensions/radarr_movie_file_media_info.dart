...
extension LunaRadarrMovieFileMediaInfo on RadarrMovieFileMediaInfo {
    ...
    String get lunaVideoBitrate {
        if(videoBitrate != null) return '${videoBitrate.lunaBytesToString(bytes: false)}/s';
        return LunaUI.TEXT_EMDASH;
    }
    ...
    String get lunaAudioBitrate {
        if(audioBitrate != null) return '${audioBitrate.lunaBytesToString(bytes: false)}/s';
        return LunaUI.TEXT_EMDASH;
    }
    ...
    String get lunaAudioAdditionalFeatures {
        if(audioAdditionalFeatures != null && audioAdditionalFeatures.isNotEmpty) return audioAdditionalFeatures;
        return LunaUI.TEXT_EMDASH;
    }

    String get lunaAudioLanguages {
        if(audioLanguages != null && audioLanguages.isNotEmpty) return audioLanguages;
        return LunaUI.TEXT_EMDASH;
    }
