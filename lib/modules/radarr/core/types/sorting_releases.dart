...
extension RadarrReleasesSortingExtension on RadarrReleasesSorting {
    ...
    RadarrReleasesSorting fromKey(String key) {
        switch(key) {
            case 'age': return RadarrReleasesSorting.AGE;
            case 'abc': return RadarrReleasesSorting.ALPHABETICAL;
            case 'seeders': return RadarrReleasesSorting.SEEDERS;
            case 'size': return RadarrReleasesSorting.SIZE;
            case 'type': return RadarrReleasesSorting.TYPE;
            case 'weight': return RadarrReleasesSorting.WEIGHT;
            default: return null;
        } 
    }

    List<RadarrRelease> sort(List<RadarrRelease> releases, bool ascending) => _Sorter().byType(releases, this, ascending);
}
...
class _Sorter {
    List<RadarrRelease> byType(
        ...
        switch(type) {
            case RadarrReleasesSorting.AGE: return _age(releases, ascending);
            case RadarrReleasesSorting.ALPHABETICAL: return _alphabetical(releases, ascending);
            case RadarrReleasesSorting.SEEDERS: return _seeders(releases, ascending);
            case RadarrReleasesSorting.WEIGHT: return _weight(releases, ascending);
            case RadarrReleasesSorting.TYPE: return _type(releases, ascending);
            case RadarrReleasesSorting.SIZE: return _size(releases, ascending);
        }
        throw Exception('sorting type not found');
    }

    List<RadarrRelease> _alphabetical(List<RadarrRelease> releases, bool ascending) {
        ascending
    ...
    List<RadarrRelease> _seeders(List<RadarrRelease> releases, bool ascending) {
        List<RadarrRelease> _torrent = _weight(releases.where((release) => release.protocol == RadarrProtocol.TORRENT).toList(), true);
        List<RadarrRelease> _usenet = _weight(releases.where((release) => release.protocol == RadarrProtocol.USENET).toList(), true);
        ascending
