    ...
    Widget build(BuildContext context) {
        return LunaExpandableListTile(
            ...
            expandedHighlightedNodes: [
                ...
                ...history.customFormats.map<LunaHighlightedNode>((format) => LunaHighlightedNode(
                    text: format.name,
                    backgroundColor: LunaColours.blueGrey,
                )),
            ],
            expandedTableContent: history.eventType?.lunaTableContent(history, movieHistory: movieHistory) ?? [],
            onLongPress: movieHistory ? null : () async => RadarrMoviesDetailsRouter().navigateTo(context, movieId: history?.movieId ?? -1),
        );
    }
}
