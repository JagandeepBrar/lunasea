    ...
    Widget get _body => LunaListView(
        children: [
            ...
            LSCardTile(
                ...
                trailing: LSIconButton(icon: CustomIcons.history, color: LunaColours.list(1)),
            ...
            LSCardTile(
                ...
                trailing: LSIconButton(icon: Icons.tune, color: LunaColours.list(3)),
                onTap: () async => RadarrSystemStatusRouter().navigateTo(context),
            ),
            LSCardTile(
                title: LSTitle(text: 'Tags'),
                subtitle: LSSubtitle(text: 'Manage Your Tags'),
                trailing: LSIconButton(icon: Icons.style, color: LunaColours.list(4)),
