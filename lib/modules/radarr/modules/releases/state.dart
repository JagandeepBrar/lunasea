...
class RadarrReleasesState extends ChangeNotifier {
    ...
    RadarrReleasesState(BuildContext context, this._movieId) {
        if(context.read<RadarrState>().enabled) _releases = context.read<RadarrState>().api.release.get(movieId: _movieId);
    }
    ...
    RadarrReleasesSorting _sortType = RadarrDatabaseValue.DEFAULT_SORTING_RELEASES.data;
    ...
    bool _sortAscending = RadarrDatabaseValue.DEFAULT_SORTING_RELEASES_ASCENDING.data;
