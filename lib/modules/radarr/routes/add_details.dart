            ...
            ValueListenableBuilder(
                ...
                builder: (context, box, widget) {
                    ...
                    return LSCardTile(
                        ...
                        onTap: () async {
                            List _values = await LSDialogRadarr.editRootFolder(context, _rootFolders);
            ...
            ValueListenableBuilder(
                ...
                builder: (context, box, widget) {
                    ...
                    return LSCardTile(
                        ...
                        trailing: LSIconButton(icon: Icons.arrow_forward_ios),
                        onTap: () async {
                            List _values = await LSDialogRadarr.editQualityProfile(context, _qualityProfiles);
            ...
            ValueListenableBuilder(
                ...
                builder: (context, box, widget) {
                    ...
                    return LSCardTile(
                        ...
                        trailing: LSIconButton(icon: Icons.arrow_forward_ios),
                        onTap: () async {
                            List _values = await LSDialogRadarr.editMinimumAvailability(context, RadarrConstants.MINIMUM_AVAILBILITIES);
