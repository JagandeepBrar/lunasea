...
class _State extends State<RadarrMovieDetailsFilesFileBlock> {
  ...
  Widget build(BuildContext context) {
    return LunaTableCard(
      content: [
        LunaTableContent(
            title: 'relative path', body: widget.movieFile?.lunaRelativePath),
        LunaTableContent(
            title: 'video',
            body: widget.movieFile.mediaInfo.videoCodec ?? LunaUI.TEXT_EMDASH),
        LunaTableContent(
          title: 'audio',
          body: [
        ...
        LunaTableContent(
            title: 'languages', body: widget.movieFile?.lunaLanguage),
        LunaTableContent(title: 'quality', body: widget.movieFile?.lunaQuality),
        LunaTableContent(
            title: 'formats', body: widget.movieFile?.lunaCustomFormats),
        LunaTableContent(
            title: 'added on', body: widget.movieFile?.lunaDateAdded),
      ],
      buttons: [
