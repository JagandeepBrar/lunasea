...
class _State extends State<RadarrSearchResults> {
    ...
    Future<void> _refresh() async {
        ...
        Future.microtask(() => Provider.of<RadarrState>(context, listen: false)?.searchReleasesFilter = '');
    }
    ...
    List<RadarrReleaseData> _sort(RadarrState model, List<RadarrReleaseData> data) {
