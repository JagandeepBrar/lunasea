...
class _State extends State<RadarrSystemStatusHealthCheckPage> with AutomaticKeepAliveClientMixin {
    ...
    Widget _body() {
        return LunaRefreshIndicator(
            context: context,
            key: _refreshKey,
            onRefresh: () async => context.read<RadarrSystemStatusState>().fetchHealthCheck(context),
            child: FutureBuilder(
