        ...
        return LSListView(
            children: <Widget>[
                ...
                LSCardTile(
                    ...
                    onTap: () => LunaDialogs().textPreview(context, widget?.data?.title, widget?.data?.path ?? 'Unknown'),
                ),
                LSContainerRow(
                    children: <Widget>[
                        Expanded(
                        ...
                        if(widget.data.imdbId != '') Expanded(
                            child: LSCard(
                                child: InkWell(
                                    ...
                                    onTap: () async => await widget.data?.imdbId?.lunaOpenIMDB(),
                                ),
                                reducedMargin: true,
                            ),
                        ),
                        if(widget.data.tmdbId != null && widget.data.tmdbId != 0) Expanded(
                            child: LSCard(
                                child: InkWell(
                                    ...
                                    borderRadius: BorderRadius.circular(Constants.UI_BORDER_RADIUS),
                                    onTap: () async => await widget.data?.tmdbId?.toString()?.lunaOpenTheMovieDB(),
                                ),
                                reducedMargin: true,
                            ),
                        ),
                        if(widget.data.youtubeId != '') Expanded(
                            child: LSCard(
                                child: InkWell(
                                    ...
                                    borderRadius: BorderRadius.circular(Constants.UI_BORDER_RADIUS),
                                    onTap: () async => await widget.data?.youtubeId?.lunaOpenYouTube(),
                                ),
                                reducedMargin: true,
                            ),
                        ),
