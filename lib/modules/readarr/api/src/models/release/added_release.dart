...
/// Model for an episode release that was added to Readarr.
...
class ReadarrAddedRelease {
  ...
  /// Deserialize a JSON map to a [ReadarrAddedRelease] object.
  factory ReadarrAddedRelease.fromJson(Map<String, dynamic> json) =>
      _$ReadarrAddedReleaseFromJson(json);

  /// Serialize a [ReadarrAddedRelease] object to a JSON map.
