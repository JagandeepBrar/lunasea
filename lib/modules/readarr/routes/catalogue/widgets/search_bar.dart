...
class _State extends State<ReadarrAuthorSearchBar> {
  ...
  void initState() {
    super.initState();
    _controller.text = context.read<ReadarrState>().seriesSearchQuery;
        ...
        Expanded(
          child: Consumer<ReadarrState>(
            builder: (context, state, _) => LunaTextInputBar(
              ...
              autofocus: false,
              onChanged: (value) =>
                  context.read<ReadarrState>().seriesSearchQuery = value,
        ...
        AnimatedContainer(
          ...
          child: Row(
            children: [
              ...
              Flexible(
                child: ReadarrAuthorSearchBarViewButton(controller: _sc),
              ),
            ],
          ),
        ),
