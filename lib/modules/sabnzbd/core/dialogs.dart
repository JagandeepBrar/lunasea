...
class SABnzbdDialogs {
        ...
        await LunaDialog.dialog(
            ...
            content: List.generate(
                ...
                (index) => LunaDialog.tile(
                    text: _options[index][0],
                    icon: _options[index][1],
                    iconColor: _options.length == 1 ? LunaColours.red : LunaColours().byListIndex(index),
                    onTap: () => _setValues(true, _options[index][2]),
                ),
            ),
            contentPadding: LunaDialog.listDialogContentPadding(),
    ...
    static Future<List<dynamic>> customSpeedLimit(BuildContext context) async {
        ...
        await LunaDialog.dialog(
            ...
            content: [
                LunaDialog.textContent(text: 'Please enter a percentage between 1 and 100.'),
                Form(
                    key: _formKey,
                    child: LunaDialog.textFormInput(
                        controller: _textController,
    ...
    static Future<List<dynamic>> deleteHistory(BuildContext context) async {
        ...
        await LunaDialog.dialog(
            ...
            content: [
                LunaDialog.textContent(text: 'Are you sure you want to delete the history for this job?'),
            ],
            contentPadding: LunaDialog.textDialogContentPadding(),
        );
        return [_flag];
