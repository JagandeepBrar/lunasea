            ...
            children: <Widget>[
                Padding(
                    child: LinearPercentIndicator(
                        ...
                        progressColor: widget.data.isPaused ? LunaColours.accent.withOpacity(0.30) : LunaColours.accent,
                        backgroundColor: widget.data.isPaused ? LunaColours.accent.withOpacity(0.05) : LunaColours.accent.withOpacity(0.15),
                        lineHeight: 4.0,
                    ),
...
class _Helper {
    ...
    Future<void> _category() async {
        ...
        .then((_) {
            showLunaSuccessSnackBar(
                title: values[1] == '' ? 'Category Set (No Category)' : 'Category Set (${values[1]})',
                message: data.name,
            );
            refresh();
        })
