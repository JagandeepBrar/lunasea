...
class _State extends State<SABnzbdQueueTile> {
    ...
    Future<void> _handlePopup() async {
        ...
        List values = await SABnzbdDialogs.showQueueSettingsPrompt(widget.queueContext, widget.data.name, widget.data.isPaused);
...
class _Helper {
    ...
    Future<void> _category() async {
        ...
        List values = await SABnzbdDialogs.showCategoryPrompt(context, categories);
    ...
    Future<void> _rename() async {
        List values = await SABnzbdDialogs.showRenameJobPrompt(context, data.name);
