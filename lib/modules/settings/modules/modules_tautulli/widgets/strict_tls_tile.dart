...
class SettingsModulesTautulliStrictTLSTile extends StatelessWidget {
    @override
    Widget build(BuildContext context) => LSCardTile(
        title: LSTitle(text: 'Strict SSL/TLS Validation'),
        subtitle: LSSubtitle(text: 'For Invalid Certificates'),
        trailing: Switch(
            value: Database.currentProfileObject.tautulliStrictTLS ?? true,
    ...
    Future<void> _onChanged(BuildContext context, bool value) async {
        if(value) {
            Database.currentProfileObject.tautulliStrictTLS = value;
