...
class SettingsConfigurationRadarrDefaultPagesRouter extends LunaPageRouter {
    SettingsConfigurationRadarrDefaultPagesRouter() : super('/settings/configuration/radarr/pages');
    ...
    Widget _homePage() {
        return RadarrDatabaseValue.NAVIGATION_INDEX.listen(
            builder: (context, box, _) => LunaListTile(
                ...
                subtitle: LunaText.subtitle(text: RadarrNavigationBar.titles[RadarrDatabaseValue.NAVIGATION_INDEX.data]),
    ...
    Widget _movieDetailsPage() {
        return RadarrDatabaseValue.NAVIGATION_INDEX_MOVIE_DETAILS.listen(
            builder: (context, box, _) => LunaListTile(
                ...
                subtitle: LunaText.subtitle(text: RadarrMovieDetailsNavigationBar.titles[RadarrDatabaseValue.NAVIGATION_INDEX_MOVIE_DETAILS.data]),
                trailing: LunaIconButton(icon: RadarrMovieDetailsNavigationBar.icons[RadarrDatabaseValue.NAVIGATION_INDEX_MOVIE_DETAILS.data]),
                onTap: () async {
                    Tuple2<bool, int> values = await RadarrDialogs().setDefaultPage(
                        context,
    ...
    Widget _addMoviePage()  {
        return RadarrDatabaseValue.NAVIGATION_INDEX_ADD_MOVIE.listen(
            builder: (context, box, _) => LunaListTile(
                ...
                subtitle: LunaText.subtitle(text: RadarrAddMovieNavigationBar.titles[RadarrDatabaseValue.NAVIGATION_INDEX_ADD_MOVIE.data]),
                trailing: LunaIconButton(icon: RadarrAddMovieNavigationBar.icons[RadarrDatabaseValue.NAVIGATION_INDEX_ADD_MOVIE.data]),
                onTap: () async {
                    Tuple2<bool, int> values = await RadarrDialogs().setDefaultPage(
                        context,
    ...
    Widget _systemStatusPage() {
        return RadarrDatabaseValue.NAVIGATION_INDEX_SYSTEM_STATUS.listen(
            builder: (context, box, _) => LunaListTile(
                ...
                subtitle: LunaText.subtitle(text: RadarrSystemStatusNavigationBar.titles[RadarrDatabaseValue.NAVIGATION_INDEX_SYSTEM_STATUS.data]),
                trailing: LunaIconButton(icon: RadarrSystemStatusNavigationBar.icons[RadarrDatabaseValue.NAVIGATION_INDEX_SYSTEM_STATUS.data]),
                onTap: () async {
                    Tuple2<bool, int> values = await RadarrDialogs().setDefaultPage(
                        context,
