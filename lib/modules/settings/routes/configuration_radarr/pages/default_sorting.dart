    ...
    return RadarrDatabaseValue.DEFAULT_SORTING_MOVIES.listen(
      builder: (context, box, _) => LunaListTile(
        ...
        subtitle: LunaText.subtitle(
            text: (RadarrDatabaseValue.DEFAULT_SORTING_MOVIES.data
        ...
        onTap: () async {
          ...
          if (values.item1) {
            RadarrDatabaseValue.DEFAULT_SORTING_MOVIES
                .put(RadarrMoviesSorting.values[values.item2]);
  ...
  Widget _sortingMoviesDirection() {
    return RadarrDatabaseValue.DEFAULT_SORTING_MOVIES_ASCENDING.listen(
      builder: (context, box, _) => LunaListTile(
        ...
        subtitle: LunaText.subtitle(
          text: RadarrDatabaseValue.DEFAULT_SORTING_MOVIES_ASCENDING.data
              ? 'Ascending'
              : 'Descending',
        ),
        trailing: LunaSwitch(
  ...
  Widget _filteringMovies() {
    return RadarrDatabaseValue.DEFAULT_FILTERING_MOVIES.listen(
      builder: (context, box, _) => LunaListTile(
        ...
        subtitle: LunaText.subtitle(
            text: (RadarrDatabaseValue.DEFAULT_FILTERING_MOVIES.data
                    as RadarrMoviesFilter)
                .readable),
        trailing: LunaIconButton(icon: Icons.arrow_forward_ios_rounded),
        onTap: () async {
          List<String> titles =
              RadarrMoviesFilter.values.map<String>((e) => e.readable).toList();
          Tuple2<bool, int> values = await RadarrDialogs()
              .setDefaultSortingOrFiltering(context, titles: titles);
          if (values.item1) {
            RadarrDatabaseValue.DEFAULT_FILTERING_MOVIES
                .put(RadarrMoviesFilter.values[values.item2]);
            context.read<RadarrState>().moviesFilterType =
  ...
  Widget _sortingReleases() {
    return RadarrDatabaseValue.DEFAULT_SORTING_RELEASES.listen(
      builder: (context, box, _) => LunaListTile(
        ...
        subtitle: LunaText.subtitle(
            text: (RadarrDatabaseValue.DEFAULT_SORTING_RELEASES.data
        ...
        onTap: () async {
          ...
          Tuple2<bool, int> values = await RadarrDialogs()
              .setDefaultSortingOrFiltering(context, titles: titles);
          if (values.item1)
            RadarrDatabaseValue.DEFAULT_SORTING_RELEASES
                .put(RadarrReleasesSorting.values[values.item2]);
        },
      ),
    );
  }
  ...
  Widget _sortingReleasesDirection() {
    return RadarrDatabaseValue.DEFAULT_SORTING_RELEASES_ASCENDING.listen(
      builder: (context, box, _) => LunaListTile(
        ...
        subtitle: LunaText.subtitle(
            text: RadarrDatabaseValue.DEFAULT_SORTING_RELEASES_ASCENDING.data
                ? 'Ascending'
                : 'Descending'),
        trailing: LunaSwitch(
  ...
  Widget _filteringReleases() {
    return RadarrDatabaseValue.DEFAULT_FILTERING_RELEASES.listen(
      builder: (context, box, _) => LunaListTile(
        ...
        subtitle: LunaText.subtitle(
            text: (RadarrDatabaseValue.DEFAULT_FILTERING_RELEASES.data
        ...
        onTap: () async {
          ...
          Tuple2<bool, int> values = await RadarrDialogs()
              .setDefaultSortingOrFiltering(context, titles: titles);
          if (values.item1)
            RadarrDatabaseValue.DEFAULT_FILTERING_RELEASES
                .put(RadarrReleasesFilter.values[values.item2]);
        },
      ),
    );
  }
