    ...
    Widget get _body => LSListView(
        children: <Widget>[
            ...
            LSCardTile(
                ...
                onTap: () async => LSDialogSystem.textPreview(context, 'Message', _arguments?.log?.text),
            ),
            if(_arguments?.log?.exception != 'null') LSCardTile(
                ...
                trailing: LSIconButton(icon: Icons.arrow_forward_ios),
                onTap: () async => LSDialogSystem.textPreview(context, 'Exception', _arguments?.log?.exception, alignLeft: true),
            ),
            if(_arguments?.log?.stacktrace != 'null') LSCardTile(
                ...
                trailing: LSIconButton(icon: Icons.arrow_forward_ios),
                onTap: () async => LSDialogSystem.textPreview(context, 'Stack Trace', _arguments?.log?.stacktrace, alignLeft: true),
            ),
        ],
        padBottom: true,
    );
