...
class SonarrSeriesDetailsOverview extends StatelessWidget {
    ...
    Widget _information(BuildContext context) => LSTableBlock(
        children: [
            ...
            LSTableContent(title: 'quality', body: profile?.name ?? 'Unknown'),
            if(Provider.of<SonarrState>(context, listen: false).enableVersion3) LSTableContent(title: 'language', body: ''),
