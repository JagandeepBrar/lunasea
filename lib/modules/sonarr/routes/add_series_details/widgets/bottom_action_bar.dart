    ...
    if (context.read<SonarrState>().api != null) {
      ...
      await context
          ...
          .addSeries(
            ...
            profileId:
                context.read<SonarrSeriesAddDetailsState>().qualityProfile.id,
            languageProfileId:
                context.read<SonarrSeriesAddDetailsState>().languageProfile.id,
            title: context.read<SonarrSeriesAddDetailsState>().series.title,
            titleSlug:
                context.read<SonarrSeriesAddDetailsState>().series.titleSlug,
            ...
            rootFolderPath:
                context.read<SonarrSeriesAddDetailsState>().rootFolder.path,
            tvRageId:
                context.read<SonarrSeriesAddDetailsState>().series.tvRageId,
            seasonFolder:
            ...
            tags: context
                ...
                .map<int>((e) => e.id)
                .toList(),
            ignoreEpisodesWithFiles: SonarrDatabaseValue
                        .ADD_SERIES_DEFAULT_MONITOR_STATUS.data ==
                    SonarrMonitorStatus.MISSING ||
                SonarrDatabaseValue.ADD_SERIES_DEFAULT_MONITOR_STATUS.data ==
                    SonarrMonitorStatus.FUTURE,
            ignoreEpisodesWithoutFiles: SonarrDatabaseValue
                        .ADD_SERIES_DEFAULT_MONITOR_STATUS.data ==
                    SonarrMonitorStatus.EXISTING ||
                SonarrDatabaseValue.ADD_SERIES_DEFAULT_MONITOR_STATUS.data ==
                    SonarrMonitorStatus.FUTURE,
        ...
        Navigator.of(context).popAndPushNamed(
            SonarrSeriesDetailsRouter().route(seriesId: addedSeries.id));
      }).catchError((error, stack) {
        context.read<SonarrSeriesAddDetailsState>().state =
            LunaLoadingState.ERROR;
        LunaLogger().error(
            'Failed to add series: ${context.read<SonarrSeriesAddDetailsState>().series.tvdbId}',
            error,
            stack);
