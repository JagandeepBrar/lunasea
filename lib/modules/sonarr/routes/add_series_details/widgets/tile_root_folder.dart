...
class SonarrSeriesAddDetailsRootFolderTile extends StatelessWidget {
    ...
    Widget build(BuildContext context) {
        return LunaListTile(
            ...
            subtitle: LunaText.subtitle(text: context.watch<SonarrSeriesAddDetailsState>().rootFolder?.path ?? Constants.TEXT_EMDASH),
    ...
    Future<void> _onTap(BuildContext context) async {
        ...
        Tuple2<bool, SonarrRootFolder> result = await SonarrDialogs().editRootFolder(context, _folders);
        if(result.item1) {
