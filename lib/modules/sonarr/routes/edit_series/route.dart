...
class _State extends State<_SonarrEditSeriesRoute> with LunaLoadCallbackMixin, LunaScrollControllerMixin {
    ...
    Widget build(BuildContext context) {
        if(widget.seriesId <= 0) return LunaInvalidRoute(
            title: 'Edit Series',
    ...
    Widget _list(BuildContext context, {
        ...
        if(context.read<SonarrSeriesEditState>().series == null) {
            ...
            context.read<SonarrSeriesEditState>().initializeQualityProfile(qualityProfiles);
            context.read<SonarrSeriesEditState>().initializeLanguageProfile(languageProfiles);
