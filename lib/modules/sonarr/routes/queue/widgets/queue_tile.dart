  ...
  Widget _collapsed(BuildContext context) {
    return LunaListTile(
      ...
      trailing: Column(
        ...
        children: [
          LunaIconButton(
              icon: widget.record.lunaStatusIcon,
              color: widget.record.lunaStatusColor),
        ],
      ),
      contentPadding: true,
                ...
                children: [
                  ...
                  Padding(
                    child: Wrap(
                      ...
                      children: [
                        LunaHighlightedNode(
                          text: widget.record?.protocol
                                  ?.lunaCapitalizeFirstLetters() ??
                              LunaUI.TEXT_EMDASH,
                          backgroundColor: LunaColours.blue,
                        ),
                        LunaHighlightedNode(
                          text: widget.record?.quality?.quality?.name ??
                              'Unknown',
                          backgroundColor: LunaColours.accent,
                        ),
                        LunaHighlightedNode(
                          text:
                              '${widget.record?.lunaPercentageComplete ?? LunaUI.TEXT_EMDASH}%',
                          ...
                          TextSpan(
                            ...
                            text: widget.record.episode.airDateUtc == null
                                ...
                                : DateFormat.yMMMMd().format(
                                    widget.record.episode.airDateUtc.toLocal()),
                          ),
                        ],
                      ),
                    ),
                  ...
                  Padding(
                    child: RichText(
                      text: TextSpan(
                        ...
                        text: widget.record.episode.overview != null &&
                                widget.record.episode.overview.isNotEmpty
                        ...
                        LunaButton.text(
                          ...
                          onTap: () async {
                            LunaDialogs().showMessages(
                              context,
                              widget.record.statusMessages
                                  .map<String>(
                                      (status) => status.messages.join('\n'))
                                  .toList(),
                            );
                          },
                        ),
    ...
    if (_result)
      context
        ...
        showLunaErrorSnackBar(
            title: 'Failed to Delete From Queue', error: error);
      });
  }
}
