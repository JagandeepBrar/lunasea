...
extension TautulliStatisticsTimeRangeExtension on TautulliStatisticsTimeRange {
    String get name {
        switch(this) {
            case TautulliStatisticsTimeRange.ONE_WEEK: return '1 Week';
            case TautulliStatisticsTimeRange.TWO_WEEK: return '2 Weeks';
    ...
    int get value {
        switch(this) {
            case TautulliStatisticsTimeRange.ONE_WEEK: return 7;
            case TautulliStatisticsTimeRange.TWO_WEEK: return 14;
