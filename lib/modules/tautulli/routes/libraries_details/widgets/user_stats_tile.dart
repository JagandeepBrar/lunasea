...
class TautulliLibrariesDetailsUserStatsTile extends StatelessWidget {
    ...
    Widget build(BuildContext context) {
        return LunaTwoLineCardWithPoster(
            posterUrl: context.watch<TautulliState>().getImageURLFromPath(user.userThumb),
            posterHeaders: context.watch<TautulliState>().headers.cast<String, String>(),
    ...
    Future<void> _onTap(BuildContext context) => TautulliUserDetailsRouter().navigateTo(
        context,
        userId: user.userId,
    );
}
