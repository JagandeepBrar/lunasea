...
class _State extends State<_TautulliLogsPlexMediaServerRoute> with LunaScrollControllerMixin {
    ...
    Widget _body(BuildContext context) {
        return LunaRefreshIndicator(
            context: context,
            key: _refreshKey,
            onRefresh: () async => context.read<TautulliLogsPlexMediaServerState>().fetchLogs(context),
            child: FutureBuilder(
                future: context.select((TautulliLogsPlexMediaServerState state) => state.logs),
    ...
    Widget _logs(List<TautulliPlexLog> logs) {
        ...
        return LunaListViewBuilder(
            ...
            itemBuilder: (context, index) => TautulliLogsPlexMediaServerLogTile(log: _reversed[index]),
        );
    }
}
