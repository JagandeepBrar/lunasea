...
class TautulliSearchResultTile extends StatelessWidget {
    ...
    Widget get _subtitleOne {
        ...
        switch(result.mediaType) { 
            ...
            case TautulliMediaType.COLLECTION: _text = '${result?.minYear ?? 0} ${LunaUI.TEXT_EMDASH} ${result?.maxYear ?? 0}'; break;
            default: break;
        }
        return LunaText.subtitle(text: _text, maxLines: 1);
    }

    Widget get _subtitleTwo => LunaText.subtitle(text: result.grandparentTitle, maxLines: 1);
    ...
    Future<void> _onTap(BuildContext context) async => TautulliMediaDetailsRouter().navigateTo(
        context,
