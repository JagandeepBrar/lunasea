...
class _State extends State<TautulliUserDetailsHistory> with AutomaticKeepAliveClientMixin, LunaLoadCallbackMixin {
    ...
    Widget _history(TautulliHistory history) {
        if((history?.records ?? 0) == 0) return LunaMessage(
