import 'package:lunasea/core/extensions/navigator_state.dart';
...
class LunaProfile {
  ...
  static ProfileHiveObject get current {
    ...
    return LunaBox.profiles.read(enabled) ?? ProfileHiveObject.empty();
  }
  ...
  bool changeTo(
    ...
    try {
      ...
      if (popToRoot) {
        LunaState.navigatorKey.currentState!.lunaPopToFirst();
      }
  ...
  Future<void> _create(String profile) async {
    ...
    await LunaBox.profiles.update(profile, ProfileHiveObject.empty());
  }
  ...
  Future<void> _rename(String oldProfile, String newProfile) async {
    ...
    final newDb = ProfileHiveObject.fromProfileHiveObject(oldDb);
