...
class CustomIcons {
    ...
    static const IconData sabnzbd = const IconData(0xe800, fontFamily: _kFontFam);
    ...
    static const IconData queue = const IconData(0xe80c, fontFamily: _kFontFam);
    static const IconData history = const IconData(0xe80d, fontFamily: _kFontFam);
    static const IconData home = const IconData(0xe80e, fontFamily: _kFontFam);
    static const IconData calendar = const IconData(0xe80f, fontFamily: _kFontFam);
    static const IconData settings = const IconData(0xe810, fontFamily: _kFontFam);
